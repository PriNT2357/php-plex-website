...
class NiceSSH {
	...
	public function __construct($host, $port = 22, $fingerprint = 'xxxxxxxx', $user = 'username', $pubkeyfile = '/home/username/.ssh/id_rsa.pub', $prikeyfile = '/home/username/.ssh/id_rsa', $passphrase = null) {
		$this->ssh_host = $host;
		$this->ssh_port = $port;
		$this->ssh_server_fp = $fingerprint;
		$this->ssh_auth_user = $user;
		$this->ssh_auth_pub = $pubkeyfile;
		$this->ssh_auth_priv = $prikeyfile;
		$this->ssh_auth_pass = $passphrase;
	}
